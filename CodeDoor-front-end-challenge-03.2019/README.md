...
- [ ] Submit well-formatted and valid HTML and CSS code.  
...
## Stretch Goals (upon request)
Depending on your skill level and experience, your CodeDoor coordinator might request the following additional requirements:
